...
export class MultiModalProcessor {
    ...
    static async detectImageProtocol() {
    ...
    static async displayImage(imagePath, options = {}) {
    ...
    static async displayKitty(imagePath, dims) {
    ...
    static async displayIterm(imagePath, dims) {
    ...
    static async displaySixel(imagePath, dims) {
    ...
    static async displayAscii(imagePath, dims) {
    ...
    // Play audio file
    static async playAudio(audioPath) {
    ...
    static async displayVideoFrame(videoPath, timestamp = '00:00:01') {
