...
export class EnterpriseConnectors {
    ...
    // GitHub operations
    async github(connectionName, operation, args) {
    ...
    // Slack operations
    async slack(connectionName, operation, args) {
        const conn = this.connections.get(connectionName);
    ...
    // Notion operations
    async notion(connectionName, operation, args) {
        const conn = this.connections.get(connectionName);
    ...
    // Jira operations
    async jira(connectionName, operation, args) {
        const conn = this.connections.get(connectionName);
    ...
    // Linear operations
    async linear(connectionName, operation, args) {
        const conn = this.connections.get(connectionName);
    ...
    async api(connectionName, endpoint, options = {}) {
        const conn = this.connections.get(connectionName);
        if (!conn)
